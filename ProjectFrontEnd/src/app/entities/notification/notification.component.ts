 ...
 *
 * <app-notification [id]='id' [tweetTrigger]='tweet' ></app-notification>
 */
@Component({
...
export class NotificationComponent implements OnInit {
  ...
  @Input()
  tweetTrigger: TweetComponent;

  @Input()
  userToNotify: UserComponent;

  @Input()
  userWhoNotifies: UserComponent
  ...
  ngOnInit(): void {
    this.hasText = this.notificationType !== "MENTION";
